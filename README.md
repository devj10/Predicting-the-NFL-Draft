...
We employ XGBoost, neural networks, and random forests to predict both first-round draft likelihood and the specific
round in which a player will be selected. Our results demonstrate the effectiveness of machine learning in enhancing draft
predictions, providing an objective alternative to traditional scouting methodologies.
